...
<head>
    ...
    <script>
        ...
        function doSelect(a, b) {
            opener.document.wallet.name.value = b;
            opener.document.wallet.debit_walletid.value = a;
        ...
        function doClick(v1, v2) {
            alert(v1 + "==" + v2);
            	window.document.getElementByName('name').value = v1;
                window.document.getElementByName('walletID').value = v2;
                alert(v2);
              window.close();
        }
    </script>
...
<div class="top-buffer6 mainbox col-md-8 col-md-offset-2 col-sm-6 col-sm-offset-5 row">
    <div style="background-color: #f2f2f2;" class="panel panel-default">
        <div class="panel-heading" style="background-color: #122b40;color: white">
            <h1 class="panel-title text-center">Search Wallet</h1>
        </div>
        <div class="panel-body">
            <form:form name="search" method="get" modelAttribute="wallet" action="/search">
                <div class="col-md-12">
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="walletID">Wallet Id:</label>
                            <input type="text" class="form-control" id="walletID">
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
    ...
    <table  id="example" class="table table-striped table-bordered hover">
        ...
        <c:forEach var="bo"
            ...
            <tr>
                ...
                <td><a href="#" onclick="doSelect('${bo.walletID}','${bo.name}')">Select</a></td>
            </tr>
        </c:forEach>
    </table>
</div>
